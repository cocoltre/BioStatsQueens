...
model_stats <- glance(model)[, c("r.squared", "adj.r.squared", "sigma", "statistic", "p.value", "df")]
...
The 2-way interactions model, which is more complex than the step model, explains approximately 79.9% of the variance in Mortgage Yield. The Residual Standard Error (0.1002) is low, and the overall model is highly significant (p \< 0.001), indicating that at least one of the terms has a significant influence on Mortgage Yield.
