...
%\~%25%), indicating that most regions had moderate growth, while a few
...
**3. Savings per New Unit Built :** There seems to be a negative
...
**4. Savings per Capita:** The relationship is less distinguishable but
...
-   **X2** and **X3** also show strong and significant associations
    ($R^2$ = 0.546 and 0.517, respectively).
...
the most promising candidates for predicting mortgage yield in a multivariate model.
