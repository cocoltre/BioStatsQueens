...
# Set minimum size to avoid quartz device error
min_size_in <- 1
w <- max(w, min_size_in)
h <- max(h, min_size_in)

# Save PNG exactly sized to table content
png("full_model_fitstats_table.png", width = w, height = h, units = "in", res = 300, bg = "white")
grid.draw(table1)
...
# Export PNG ajusté au contenu
png("interaction_model_coef.png", width = w, height = h, units = "in", res = 300, bg = "white")
grid.draw(table1)
...
# Export PNG ajusté au contenu
png("interaction_model_fitstats.png", width = w, height = h, units = "in", res = 300, bg = "white")
grid.draw(table2)
