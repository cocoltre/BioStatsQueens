...
author: "Group 42 : Clara Delandre, Majandra Garcia, Paola Biocchi, Coline Leteurte"
date: "`r Sys.Date()`"
output: pdf_document
...
header-includes:
  ...
  - \usepackage{caption}
  - \pagestyle{fancy}
  - \fancyhead[L]{Group Member Names Here}
  - \fancyfoot[C]{\thepage}
editor_options: 
  markdown: 
    wrap: 72
...
=======
Mortgage Yield (`mortYld`) is predicted based on economic and demographic factors. This study examines how **various economic and geographic factors influence mortgage yield (%)**, using data from historical mortgage reports. The aim is to develop a predictive model for mortgage yield based on six explanatory variables:
>>>>>>> 21ccb1042f3a597c90f879dba1637454adc071d9
