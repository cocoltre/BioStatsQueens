...
We end up with : $\hat{mortYld}$ = 4.29 + 0.020$\cdot$**X1** + 1.36$\cdot$$10^{-5}$$\cdot$**X2** - 1.58$\cdot$$10^{-3}$$\cdot$**X3** + 2.02$\cdot$$10^{-4}$$\cdot$**X4** + 1.28$\cdot$$10^{-3}$$\cdot$**X5** +
...
more appropriate.\
We end up with : $\hat{mortYld}$ = 5.37 + 6.91$\cdot$$10^{-3}$$\cdot$**X1** - 1.04$\cdot$$10^{-4}$$\cdot$**X3** - 9.10$\cdot$$10^{-4}$$\cdot$**X4** - 2.09$\cdot$$10^{-5}$$\cdot$**X1**:**X3** + 1.50$\cdot$$10^{-5}$$\cdot$**X1**:**X4** - 4.75$\cdot$$10^{-8}$$\cdot$**X3**:**X4**\
\
...
text(min(fitted(model)), max(resid(model)) * 0.9, 
     labels = paste0("y = ", formatC(coef_res_fit[2], format = "e", digits=2), "*x + ", formatC(coef_res_fit[1], format = "e", digits=2)), 
...
# Conclusion
The final estimated model is : $\hat{mortYld}$ = 4.22 + 0.022$\cdot$**X1** -
1.86$\cdot$$10^{-3}$$\cdot$**X3** + 2.25$\cdot$$10^{-4}$$\cdot$**X4**\
