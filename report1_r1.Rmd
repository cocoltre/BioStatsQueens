...
header-includes:
  ...
  - \fancyfoot[C]{\thepage}
  - \usepackage{titlesec}
  - \titlespacing*{\title}{0pt}{-5cm}{0pt}  # Move title even higher
  - \titlespacing*{\author}{0pt}{-4.5cm}{0pt}  # Move author higher
  - \titlespacing*{\date}{0pt}{-4.5cm}{0pt}  # Move date higher
  - \usepackage{etoolbox}
  - \patchcmd{\maketitle}{\vspace*{2\baselineskip}}{}{}{}  # Remove extra space in title block
  - \setlength{\topmargin}{-2cm}  # Move everything up
  - \setlength{\headheight}{12pt}  # Minimal headheight to avoid fancyhdr warnings
