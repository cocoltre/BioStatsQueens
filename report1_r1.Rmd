...
```{r}
# Select only the relevant numerical variables (X1 to X6 and mortYld)
...
Here we can see that the Null model don't fit the data. We really should the variables.
