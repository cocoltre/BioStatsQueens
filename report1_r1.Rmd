...
practices. The histograms confirm the distribution of the explanatory variables:
...
indicating that most regions had moderate growth, while a few experienced rapid expansion.
...
par(mfrow = c(2, 3))
par(mai = c(0.6, 0.6, 0.5, 0.6))  # bas, gauche, haut, droite
...
\
We end up with : `mortYld` = 4.2852 + 0.0203$\times$X1 + 0.0$\times$X2 - 0.0016$\times$X3 + 0.0002$\times$X4 + 0.0013$\times$X5 + 0.0002$\times$X6
...
\
We end up with : `mortYld` = 4.223 + 0.02229$\times$X1 - 0.001863$\times$X3 + 0.0002249$\times$X4\
\
